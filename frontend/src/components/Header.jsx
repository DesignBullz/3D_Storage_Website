      ...
      <div className="max-w-screen-xl mx-auto flex justify-between items-center flex-col sm:flex-row">
        ...
        <nav className="flex space-x-5 sm:space-x-8 ml-auto">
          ...
          <a
            ...
            className="bg-white font-heading font-semibold text-red-700 px-6 py-2 rounded-full font-body font-medium"
          >
          ...
          <a
            ...
            className="bg-white font-heading font-semibold text-red-700 px-6 py-2 rounded-full font-body font-medium"
          >
            <FaCalculator className="inline-block mr-2 text-lg" /> Calculator
          </a>
